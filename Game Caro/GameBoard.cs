...
namespace Game_Caro
{
    class GameBoard
    {
        ...
        public GameBoard(Panel board, TextBox PlayerName, PictureBox Avatar)
        {
            ...
            {
                new Player("Trung Hưng", Image.FromFile(Application.StartupPath + "\\images\\TH.png"),
                                        Image.FromFile(Application.StartupPath + "\\images\\P11.png")),

                new Player("Minh Hoàng", Image.FromFile(Application.StartupPath + "\\images\\MH.png"),
                                   Image.FromFile(Application.StartupPath + "\\images\\P21.png"))
            };       
        }      
        #endregion
